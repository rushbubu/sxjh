...
const _BR_SEX_POSITIONS_T2 = {
    normal: {
        ...
        desc: [
            ...
            '她搂着你的脖子，在你耳边吹着热气：「好爷……您一边干一边摸奴家的奶……奴家最喜欢了……」你握住{breast_short}揉捏着，她果然叫得更浪了，{pp_name}咬得你舒爽难当。蜜汁顺着你的大腿往下淌。',
        ], mA: 10, fA: 12,
    },
    cowgirl: {
        name: '女上位',
...
const BROTHEL_FOREPLAY_SCENES_T2 = {
    ...
    chest: { common: [
        ...
        ['你解开她衣襟，对着那{breast_short}轻轻吹了口气，眼看着那{nipple}的乳尖在你气息下挺立。你伸出舌尖轻轻一舔，她浑身一颤。', '她低头看着自己的乳尖在你舌尖下变硬，声音又颤又媚：「爷……您别光看不练呀……吸一口……」'],
    ]},
    waist: { common: [
...
const BROTHEL_FOREPLAY_SCENES_T3 = {
    ...
    chest: { common: [
        ['你的手轻轻覆上她的胸口，那{breast_short}上布满了红痕和吻痕，{nipple}的乳尖红肿着微微发颤。你只是轻轻握着，她低低地「嘶」了一声。', '她低头看了看自己胸口的狼藉，轻轻笑了笑：「爷……您给奴家咬得……真够狠的……」语气里却没有责怪的意思。'],
    ]},
    waist: { common: [
