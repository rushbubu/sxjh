...
const MARTIAL_ARTS = {
    // 村庄武学（10种）
    mantis:    { name: '螳螂拳',   desc: '模仿螳螂捕食之态的拳法，出手迅捷，虚实相生。',          luckReq: 10, type: 'fist',  quality: 'white' },
    ...
    hongquan:  { name: '洪拳',     desc: '大开大合的硬桥硬马功夫，势大力沉。',                       luckReq: 10, type: 'fist',  quality: 'white' },
    ...
    tiesha:    { name: '铁砂掌',   desc: '以铁砂练掌，掌风过处，碎石裂碑。',                         luckReq: 12, type: 'palm',  quality: 'white' },
    ...
    jingang:   { name: '金刚掌',   desc: '佛门至高掌法，一掌击出有金刚降魔之威。',                    luckReq: 25, type: 'palm',  quality: 'purple' },
    wuying:    { name: '无影脚',   desc: '出脚无影，收脚无声，中者甚至不知自己如何中招。',            luckReq: 20, type: 'kick',  quality: 'purple' },
    nianhua:   { name: '拈花指',   desc: '佛祖拈花，迦叶一笑。指法轻柔如拂花，实则可隔空点穴。',      luckReq: 25, type: 'finger',quality: 'purple' },

    // 特殊 / 道场
    yiyangzhi: { name: '一阳指',   desc: '大理段氏绝学，以指代剑，凌空点穴，天下无双。',              luckReq: 20, type: 'finger',quality: 'gold' },
};
