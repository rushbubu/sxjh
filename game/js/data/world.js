...
const WORLD = {
    ...
    villages: [
        ...
        ...[
            ...
            ['白云庄','baiyun','建在山腰上的大庄子，常年云雾缭绕。',260,3,'subsistence','xiangyang','1天脚程','云游郎中','云铁匠','云管事','云庄主','云庄主'],
            ...
            ['虎头寨','hutou','由匪寨演变的村落，尚武之风犹存。',350,2.5,'subsistence','xiangyang','1天脚程','赛华佗','龙铁锤','虎妞','龙寨主','龙寨主'],
            ...
            ['翠微村','cuiwei','大山深处的村落，四周竹林环绕。',180,1.2,'destitute','xiangyang','3天脚程','竹郎中','竹铁匠','竹酒翁','竹翁',null],
            ['金川镇','jinchuan','两河交汇处的繁忙集镇，方圆百里最大集散地。',1200,3.5,'moderate','yangzhou','2天脚程','金郎中','金大锤','酒缸周','周会长','钱百万'],
            ['山神庙','shanshen','以古老山神庙为中心的村落。',150,0.8,'destitute','jingcheng','2天脚程','山郎中','刘铁匠','庙前酒','刘庙祝',null],
            ...
            ['烟霞村','yanxia','山谷中的村落，早晚云雾如烟霞。出产贡茶。',420,1.5,'moderate','chengdu','1天脚程','陆郎中','陆铁匠','陆茶寮','陆管事','陆管事'],
            ['大黄庄','dahuang','平原上的大庄子，周围良田千亩。',680,5,'moderate','luoyang','1天脚程','黄郎中','黄铁匠','黄酒坛','黄百万','黄百万'],
            ['苗疆寨','miaojiang','苗人聚居的村寨，保留着蛊术和巫文化。',350,3,'subsistence','dali','3天脚程','蛊婆婆','苗铁匠','寨中酒','阿公',null],
            ['墨渊村','moyuan','建在废弃矿坑附近的村落，后山有前朝秘密。',200,1,'destitute','chengdu','2天脚程','墨郎中','墨铁匠','黑酒翁','老矿头',null],
            ['芦花荡','luhua','湖荡湿地中的水村，家家有船。',450,6,'subsistence','yangzhou','半日脚程','芦郎中','芦铁匠','芦花酒','吴老大','吴老大'],
            ['松涛庄','songtao','松林中的清幽居所，原是退休官员别院。',190,1.2,'subsistence','suzhou','1天脚程','王郎中','王铁匠','松风酒','王员外','王员外'],
