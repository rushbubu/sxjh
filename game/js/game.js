...
class Game {
    ...
    teachCrippleLiSkill() {
        ...
        this._questSeq([
            ...
            '「小哥儿，老夫这辈子见过两种人。」',
            '「一种人，生来力能扛鼎、天资绝世，后来才学会了什么叫是非——这种人万中无一，成了便是顶天立地的大侠。」',
            '「另一种人，出身微末、本事不大，但心里自有一杆秤——知道什么事该做，什么事打死也不能做。他们一步一步往上爬，不为万人景仰，只求护住身边想护的人。」',
            '他转过头，目光灼灼：',
            '「老夫当年……也曾差点走错了路。是前任丐帮帮主沈铁竹老哥在悬崖边上拽了我一把，把这套掌法传给了我。」',
            '「他对我说：『小李子，武功没有善恶，有善恶的是人。你心里有愧，就别让它变成一辈子的悔。』」',
            '「老夫这辈子没什么出息，但这句话记住了。今日见你，就想起当年的自己。」',
